$(document).ready(function() {
 ...
 function sendWhatsAppMessage() {
    ...
    let whatsappMessage = `Hello! 👋%0A%0A*New Contact Message*%0A--------------------%0A📛 *Name:* ${name}%0A📧 *Email:* ${email}%0A📌 *Subject:* ${subject}%0A📝 *Message:* ${message}%0A--------------------%0A%0ASent from my portfolio website.`;

    let phoneNumber = "6285888448349"; 
